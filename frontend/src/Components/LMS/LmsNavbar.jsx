...
function LmsNavbar({ inUserList }) {
  ...
  return (
    ...
    >
      ...
      >
        <Box color={"white"}>
          <NavLink to={"/lmslecture"}>Lectures</NavLink>
        </Box>

        <Box color={"white"}>
          <NavLink to={"/lmsassignment"}>Assignments</NavLink>
        </Box>
          ...
          >
            ...
            <DrawerContent>
              ...
              >
                ...
                <Box>{!show && <Text color={"white"}>{kingName}</Text>}</Box>
              </DrawerHeader>
              <DrawerCloseButton color="white" />
              <DrawerBody bgColor={"#66b9bf"} color="white" fontWeight={600}>
                <Stack spacing={30}>
                  <Box>
                    <NavLink to={"/lmslecture"}>Assignments</NavLink>
                  </Box>
                  <Box>
                    <NavLink to={"/lmsassignment"}>Lectures</NavLink>
                  </Box>
