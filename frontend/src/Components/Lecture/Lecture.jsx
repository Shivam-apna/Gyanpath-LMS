...
function Lecture() {
  ...
  let getLectures = () => {
    fetch("http://localhost:3000/adminwork/getLectures", {
      method: "GET",
      headers: {
  ...
  let handleNewLecture = () => {
    if (
      ...
      onClose();
      let url = temp
        ? `http://localhost:3000/adminwork/editlecture/${editId}`
        : "http://localhost:3000/adminwork/createLecture";
  ...
  let handleDelete = (id) => {
    fetch(`http://localhost:3000/adminwork/removelecture/${id}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
    ...
    <>
      ...
      <Box m={"auto"} p={{ sm: 30, md: 30 }}>
        <Button
          ...
          bg={"green"}
          color={"white"}
          onClick={handleModalforNewLecture}
        >
          Add Lecture
        </Button>
        <Suspense
        ...
        <>
          ...
          >
            ...
            <ModalContent>
              <ModalHeader>
                {modalheading != "" ? modalheading : "Add New Lecture"}
              </ModalHeader>
              <ModalCloseButton />
              <ModalBody pb={6}>
                <FormControl>
                ...
                <FormControl>
                  ...
                  <Select
                    value={lecture_type}
                    onChange={(e) => setlecture_type(e.target.value)}
                    ref={initialRef}
                  >
