  ...
  return (
    <Box bgColor={"#fff"} p={2} h={"100vh"} display={"flex"} flexDir={"column"} alignItems={"center"} justifyContent={"center"}>
      ...
      <Box bgColor={"#a435f0"} color={"white"} shadow={"lg"} w="fit-content" p={"3%"} borderRadius={10} display={"flex"} flexDir="column" alignItems="center" justifyContent={"center"} gap={5}>
        ...
        <Text fontWeight={600} fontSize={25}>Sign Up </Text>
        <InputGroup size='md'>
        ...
        <Button className={styles['submit']} onClick={handleForm} color={"white"} bgColor={"green"} isLoading={isLoading ? true : false}
          loadingText='Submitting'>
          submit
        </Button>
        <Text className={styles['capture-atention']} fontWeight={600} fontSize={20}>Already have an account?</Text>
