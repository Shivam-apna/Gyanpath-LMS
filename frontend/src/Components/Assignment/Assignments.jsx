...
let GridComp = lazy(() =>
  wait(1000).then(() => import("../GridComp/GridComp"))
);
function Assignments() {
  ...
  let currdate = `${yearnow}-${
    monthnow.length === 1 ? 0 + monthnow : monthnow
  }-${daynow.length === 1 ? 0 + daynow : daynow}`;
  ...
  let handleNewassignment = () => {
    if (
      ...
      const topic_name_upper =
        topic_name.charAt(0).toUpperCase() + topic_name.slice(1);
      teacher_name =
        teacher_name.charAt(0).toUpperCase() + teacher_name.slice(1);
    ...
    <>
      ...
      <Box m={"auto"} p={{ sm: 30, md: 30 }}>
        <Button
          ...
          bg={"green"}
          color={"white"}
          onClick={handleModalforNewAssignment}
        >
          Add Assignment
        </Button>
        ...
        <>
          ...
          >
            ...
            <ModalContent>
              <ModalHeader>
                {modalheading != "" ? modalheading : "Add New Assignment"}
              </ModalHeader>
              <ModalCloseButton />
              <ModalBody pb={6}>
                <FormControl>
                ...
                <FormControl>
                  ...
                  <Input
                    ...
                    onChange={(e) => setAssignment_date(e.target.value)}
                    ref={initialRef}
                ...
                <FormControl>
                  ...
                  <Input
                    ...
                    onChange={(e) => setAssignment_time(e.target.value)}
                    ref={initialRef}
                ...
                <FormControl>
                  ...
                  >
                    ...
                    <option value="Backend Development">Mera Monitor</option>
                    <option value="Backend Development">Karya Keeper</option>
                  </Select>
                </FormControl>
                ...
                <FormControl>
                  ...
                  <Select
                    ...
                    onChange={(e) => setAssignment_type(e.target.value)}
                    ref={initialRef}
                  >
